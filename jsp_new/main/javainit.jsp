...
<%@ page import="java.util.*,
                 ...
                 com.dimata.cashierweb.entity.admin.AppUser,
...
<%
//com.dimata.cashierweb.entity.masterdata.Material.setMaterialSwitchType(com.dimata.posbo.entity.masterdata.Material.WITH_USE_SWITCH_MERGE_MANUAL);
// application path
...
int cashierUserOpeningClosing=0;
    ...
    if(isMSIE){
        ...
        menuUsed = Integer.parseInt(PstSystemProperty.getValueByName("MENU_USED"));
    }
