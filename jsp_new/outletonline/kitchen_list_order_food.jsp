...
<%
    ...
    String where ="";
    if (1==1){
        where = " cbm.TRANSACTION_STATUS=1 AND cbm.TRANSACTION_TYPE=0 AND cbm.DOC_TYPE=0 AND bd.STATUS=0 and bd.STATUS_PRINT=1 and pm.CATEGORY_ID='504404582510028756'";
    }
    ...
    String whereRunning ="";
    if (1==1){
        whereRunning = " cbm.TRANSACTION_STATUS=1 AND cbm.TRANSACTION_TYPE=0 AND cbm.DOC_TYPE=0 AND bd.STATUS=1 AND bd.STATUS_PRINT=1 and pm.CATEGORY_ID='504404582510028756'";
    }
...
<a href="kitchen_list_order_food.jsp?print=0">Print OFF</a> |  <a href="kitchen_list_order_food.jsp?print=1">Print ON</a>
        ...
        <table role="grid" class="tablesorter-dropbox tablesorter hasFilters">
            ...
            <tbody aria-relevant="all" aria-live="polite">
                ...
                for(int i = 0; i < listTransaction.size(); i++) {
                    ...
                    <td align="left">
                        <a href="kitchen_list_order_food.jsp?FRM_FIELD_CASH_BILL_DETAIL_ID=<%=billDetail.getOID()%>&STATUS=2&UPDATE=1" style="color:#F90;"><em>CHECK OUT</em>
                        </a>
                    </td>
                </tr>
                <%
...
<%if(print==1){%>
<script language="JavaScript">
  window.open("<%=approot%>/servlet/com.dimata.posbo.printing.kitchenorder.PrintItemOrder?typePrint=0","corectionwh","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
</script>   
<%}%>
