                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                ...
                                                <div class="form-group">
                                                    <div class=row>
                                                        <div class="col-md-12">
                                                            <input name="notItem" id="guestname" type="text" class="form-control" placeholder="note item">
                                                        </div>
                                                    </div>
                                                </div>            
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                ...
                                                <div class="form-group">
                                                    <div class=row>
                                                        <div class="col-md-12">
                                                            <input name="notItembeverage" id="guestname" type="text" class="form-control" placeholder="note item">
                                                        </div>
                                                    </div>
                                                </div>               
                                                <div class="form-group">
