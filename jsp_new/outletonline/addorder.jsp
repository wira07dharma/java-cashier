...
<script language="JavaScript">
    ...
    function cmdOpenMember(nameMember){
        $("#posts").html("");
        $.ajax({
            url : "<%=approot%>/servlet/com.dimata.cashierweb.ajax.CheckMember?nameMember="+nameMember+"",
            type : "POST",
            async : false,
            cache: false,
            success : function(data) {
...
<script language="JavaScript">
    $("#posts").html("");
        $.ajax({
            url : "<%=approot%>/servlet/com.dimata.cashierweb.ajax.CheckTableFromRoom?roomId=<%=roomId%>&tableId=<%=tableId%>",
            type : "POST",
            async : false,
            cache: false,
            success : function(data) {
