...
<%@page import="com.dimata.cashierweb.entity.masterdata.WaitingList"%>
<%@page import="com.dimata.cashierweb.entity.masterdata.PstWaitingList"%>
<%@page import="com.dimata.cashierweb.form.masterdata.CtrlWaitingList"%>
<%@page import="com.dimata.cashierweb.form.masterdata.FrmWaitingList"%>
