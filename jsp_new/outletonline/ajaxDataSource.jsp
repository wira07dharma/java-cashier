...
<%@page import="com.dimata.cashierweb.entity.masterdata.MemberReg"%>
<%@page import="com.dimata.gui.jsp.ControlList"%>
<%@page import="com.dimata.cashierweb.session.masterdata.SessMemberReg"%>
<%@page import="com.dimata.cashierweb.entity.search.SrcMemberReg"%>
...
<%!
    ...
    public String drawListPrintBillx(Vector objectClass, int mul){
        //2
        ControlList ctrlist = new ControlList();
	...
	case 2: 
        ...
        case 4:
          ...
          case 5:   
            ...
            listOrder = new Vector(1, 1);
           whereOrder = "CD.CASH_BILL_MAIN_ID='" +oid+ "'";
            listOrder = PstBillDetail.listMat(0, 0, whereOrder, "");
           startorderx = 0;
            amountTotalx = 0;
          multiLanguageName = Integer.parseInt((String) com.dimata.system.entity.PstSystemProperty.getValueIntByName("NAME_MATERIAL_MULTI_LANGUAGE"));
            %>
           ...
           <div class="guest" style="margin:10px 0px;">
            ...
            <div class="col-md-12">
                <div class="row" id="resultSearchPrint">
                    <%=drawListPrintBillx(listOrder, multiLanguageName)%>
                </div>
            </div>
            </div>     
