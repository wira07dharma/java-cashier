...
<div class="container">
<center>
<a href="#"><img src="../imgcompany/dimata_system_logo.png" width="250" border="none" /></a>
</center>
...
<form method="post" style="margin-bottom:10px;">
    ...
    <div class="items">
        ...
        <a href="<%=approot%>/logout.jsp"><img src="../styles/takingorder/img/logout.png" alt="Smiley face" width="110"></a><br> <br>
    </div>
