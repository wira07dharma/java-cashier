...
<%@page import="com.dimata.cashierweb.entity.shoppingchart.ShopCart"%>
<%@ include file = "../main/javainit.jsp" %>
<%@ include file = "../main/check_sales.jsp" %>
...
<%
    ...
    String notItem = FRMQueryString.requestString(request, "notItem");
    String notItembeverage = FRMQueryString.requestString(request, "notItembeverage");
    int qtyerr = FRMQueryString.requestInt(request, "qtyerr");
    ...
    if (oidBillDetail != 0 & update != 0) {
        if (confirm == 1) {
            ...
            if (iCommand == Command.CANCEL && cashBillMainId != 0) {
                ...
                if (user != null) {
                    if (user.getUserGroupNew() == 1) {
                        noteErr=" reason : "+noteErr+" - authorize err :  "+user.getFullName();
                        int sucsess = ctrlBillMain.actionUpdateItem(update, oidBillDetail, status,noteErr,qtyerr);
                    }
                }
            }
        } else {
            noteVoid=" reason : "+noteVoid+" - authorize void :  "+salesName;
    ...
    if (typeFood.equals("0")) {
        //food 
        category_varian = category_varian + " "+notItem;
    } else {
        //beverage
        category_varian = category_varian_beverage+" "+notItembeverage;
    }
    ...
    if (billMain.getTableId() != 0) {
        ...
        whereOpenBill = whereOpenBill + " AND cbm.CASH_BILL_MAIN_ID=" + cashBillMainId;
    }
                                                                                                            ...
                                                                                                            <br>Meja :<%=table.getTableNumber()%>
                                                                                                                <br>
                                                                                                                                        ...
                                                                                                                                        <div class="form-group">
                                                                                                                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                                                                                                                ...
                                                                                                                                                <div class="form-group">
                                                                                                                                                    <div class=row>
                                                                                                                                                        <div class="col-md-12">
                                                                                                                                                            <input name="password" id="mobilenumber" type="password" class="form-control" placeholder="Password" required>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                 <div class="form-group">
                                                                                                                                                    <div class=row>
                                                                                                                                                        <div class="col-md-12">
                                                                                                                                                            <input name="qtyerr" id="mobilenumber" type="text" class="form-control" placeholder="qtyerr" required>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <div class="form-group">
                                                                                                                       ...
                                                                                                                       function ajaxScriptParentPage(pageTarget, titlePage, pageShow, modalTemplate, oid, titleId, bodyId){
                                                                                                                                ...
                                                                                                                                $.ajax({
                                                                                                                                 ...
                                                                                                                                 $.ajax({
                                                                                                                                    ...
                                                                                                                                    cache	: false,
                                                                                                                                    success	: function(data){
                                                                                                                                        $(".print-body-print").html(data).fadeIn("medium");
                                                                                                                    ...
                                                                                                                    <div id="myModalView" class="modal fade" tabindex="-1">
                                                                                                                        <div class="modal-dialog modal-lg">
                                                                                                                            <div class="modal-content">
                                                                                                                                ...
                                                                                                                                <div class="modal-footer">
                                                                                                                                    <button type="button" class="btn btn-primary" onclick="javascript:cmdConfirmCashier()">Confirm Bill</button>
                                                                                                                    ...
                                                                                                                    <hr>
                                                                                                                        ...
                                                                                                                        <div class="printable">
                                                                                                                            <span class="print-body-print"></span>
                                                                                                                        </div>
                                                                                                                        </body>
                                                                                                                        </html>
