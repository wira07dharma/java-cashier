...
import com.dimata.cashierweb.session.admin.SessAppPrivilegeObj;
 ...
 * @author Ardiadi
 */
public class SessUserCashierSession {
    public final static String HTTP_SESSION_CASHIER_NAME = "USER_CASHIER_SESSION";
	public final static String HTTP_SESSION_CASHIER = "CASHIER_SESSION";
	...
	public SessUserCashierSession() {
	    appUser.setUserStatus(AppUser.STATUS_LOGOUT);
	}

	public SessUserCashierSession(String hostIP) {
	    appUser.setUserStatus(AppUser.STATUS_LOGOUT);
	...
	public int doLogin(String loginID, String password){
	    AppUser user = SessAppUserCashier.getByLoginIDAndPassword(loginID, password);
      ...
      PstAppUser.updateUserStatus(appUser.getOID(), AppUser.STATUS_LOGIN);
        ...
        public int doLogin2(String loginID, String password){
	    AppUser user = SessAppUserCashier.getByLoginIDAndPasswordAllowSpv(loginID, password);
	...
	public int doLoginSales(String loginID, String password){
	    AppUser salesUser = PstAppUser.getByLoginIDAndPassword(loginID, password);
