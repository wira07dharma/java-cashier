...
package com.dimata.cashierweb.entity.admin;
...
public class AppObjInfo {
   ...
   // public static final int SHOW_ALL_INFO   = 8;
    ...
    public static final String[] strCommand = {
        "View", "Add New", "Update", "Delete", "Print", "Submit","Start", "Stop", "Approve","View Price","View Stock","Final"//update opie-eyek 20131201
    };
    ...
    public static final String[][] titleG2 = {
        ...
        /* sales */ {"Report", "AR", "Kasir", "Sales Order"},
    ...
    public static final String[][][] objectTitles = {
        ...
        // Receiving
        {   // Purchase Receive
            {"Purchase Receive","Purchase Receive Show Qty and Price"},
