...
public class PstDiscountQtyMapping extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    //discount_type
    public static final int DISC_PERSEN_PER_ITEM_UNIT = 0;
    public static final int DISC_NOMINAL_PER_ITEM_UNIT = 1;
    public static final int DISC_NOMINAL_PER_ITEM_SKU = 2;

    public static final String[] typeDiscount = {
        "Persentase Per Item Unit (%)",
        "Nominal Per Item Unit (Rp)",
        "Nominal Per Kode Barang (Rp)"
    };
