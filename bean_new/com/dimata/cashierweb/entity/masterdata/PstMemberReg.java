...
//System.out.println(sql);
    ...
    /**
     * Ari_wiweka_20130829
     * Search member untuk pencarian invoice di kasir
     * @param rs
     * @param memberreg
     */
    ...
    public static int listCountMember(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        try {
            /**
             *   String sql = "SELECT CL.* FROM " +PstBillMain.TBL_CASH_BILL_MAIN+ " AS CDM "
    ...
    public static long getContactFromLocationIntern(long oid){
		...
		try {
                        /**
                         * SELECT * FROM contact_list WHERE location_id='504404550369124437'; 
                         */
