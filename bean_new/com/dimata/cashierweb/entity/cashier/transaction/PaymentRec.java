...
public class PaymentRec extends Entity { 
    ...
    private int addOrSubstract = 0;

    private long currencyUsed = 0;

    private long receivedById = 0;

    private long coverBillingId = 0;

    private long telephoneCallId = 0;

    private long installmentPaymentId = 0;

    private long maintenanceFeePaymentId = 0;
    ...
    private long reservationCommissionId = 0;
    ...
    public void setCurrencyUsed(long currencyUsed){ this.currencyUsed = currencyUsed; }
