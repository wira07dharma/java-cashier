...
package com.dimata.cashierweb.form.admin;
...
import com.dimata.cashierweb.session.admin.*;
                ...
                try {
                    ...
                    if (rsCode == FRMMessage.NONE) {
                        ...
                        */
                        ...
                        if (SessAppUser.setUserAssignLocation(this.appUser.getOID(), userDayAssign,2)) {
                            msgString = FRMMessage.getMsg(FRMMessage.MSG_SAVED);
                        } else {
                            msgString = FRMMessage.getErr(FRMMessage.ERR_UNKNOWN);
                            excCode = 0;
