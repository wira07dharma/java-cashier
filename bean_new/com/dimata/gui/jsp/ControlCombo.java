...
//======
   ...
   public static String drawBootsratapData(String name, String blankSel, String selectVal, Vector keys, Vector vals, String attTag, String style,Vector data, String nameData)
     {
         /**
          * <div class="form-group">
                <label>Select</label>
        ...
        for (int i = 0; i < keys.size(); i++)
            ...
            s = (key.equals(selectVal)) ? "selected" : "";
            htmlSelect = htmlSelect + "\t<option data-"+nameData+"='"+datas+"' value=\"" + key + "\"" + s + ">" + val + "</option>\n";
            }
        htmlSelect = htmlSelect + "</select></div>\n";
        return htmlSelect;
     }
