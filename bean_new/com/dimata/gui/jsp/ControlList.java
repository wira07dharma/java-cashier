...
//                }
    ...
    public String drawBootstrapStripted() {
        ...
        for (int h = 0; h < header.size(); h++) {
            ...
            str = str + "<th width=\""+ headerWidth.get(h) +"\">" + (String)header.get(h) + "</th>";
        }
        str = str + "</tr>";
        //create list
        Vector tmpRow = new Vector(1, 1);
        ...
        if (data.isEmpty()) {
            str += "<tr><td colspan='" + header.size() + "' class='text-center'>No data found</td></tr>";
        }
        //str = str + "</table></td></tr></table></div>";
        str = str + "</table>";
        //System.out.println(str);
    ...
    public String drawBootstrapStriptedClass(String additionalClass) {
        String tmpStr = new String("");
        String str = new String("");
        str = "<table  id=\"example1\" class=\"table table-bordered table-striped "+additionalClass+" \" >";
        str = str +"<tr>";
        // create header
        for (int h = 0; h < header.size(); h++) {
    ...
    public String drawBootstrapStriptedClass2(String additionalClass) {
        String tmpStr = new String("");
        String str = new String("");
        str = "<table  id=\"example1\" class=\"table table-bordered table-striped "+additionalClass+" \" >";
        str = str +"<tr>";
        ...
        for (int h = 0; h < header.size(); h++) {
            String width = "";
            width = (String) headerWidth.get(h);
            if (width.length()>0){
                str = str + "<th style = 'width : "+width+"'>" + (String)header.get(h) + "</th>";
            }else{
                str = str + "<th>" + (String)header.get(h) + "</th>";
            }
