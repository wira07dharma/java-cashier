...
public class DBHandler implements I_DBType {    
    ...
    //public static String CONFIG_FILE = "/home/config.xml";  
        public static String CONFIG_FILE = com.dimata.RootClass.getThisClassPath()+
            System.getProperty("file.separator") + "cashier.xml";
	...
	public static int[] execUpdateBatchServices(String[] sql)
            throws DBException {
        Connection connection = null;
        Statement statement = null;
