...
public class PstLocation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_PersistentExcSynch, I_Outlet {
    ...
    //add by de Koyo
    public static final int FLD_LOCATION_USED_TABLE = 26;

    public static final int FLD_TAX_VIEW = 27;
    public static final int FLD_SERVICE_VIEW = 28;
    public static final int FLD_ACCOUNTING_EMAIL = 29;
    
    //added by dewok 20190205
    public static final int FLD_PRICE_TYPE_ID = 30;
    public static final int FLD_DISCOUNT_TYPE_ID = 31;
    public static final int FLD_MEMBER_GROUP_ID = 32;
    public static final int FLD_STANDART_RATE_ID = 33;
	public static final int FLD_MAX_EXCHANGE_DAY = 34;
    ...
    public long fetchExc(Entity ent) throws Exception {
        try {
            ...
            location.setTaxView(pstLocation.getdouble(FLD_TAX_VIEW));
            location.setServiceView(pstLocation.getdouble(FLD_SERVICE_VIEW));

            //add by de Koyo
            location.setLocationUsedTable(pstLocation.getInt(FLD_LOCATION_USED_TABLE));
            ...
            location.setStandardRateId(pstLocation.getlong(FLD_STANDART_RATE_ID));
    ...
    public static long insertExc(Location location) throws DBException {
        try {
            ...
            pstLocation.setDouble(FLD_TAX_VIEW, location.getTaxView());
            pstLocation.setDouble(FLD_SERVICE_VIEW, location.getServiceView());
            ...
            pstLocation.setLong(FLD_STANDART_RATE_ID, location.getStandardRateId());
    ...
    public static Vector listJoin(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT loc.*, com." + PstCompany.fieldNames[PstCompany.FLD_COMPANY_NAME] + ", dep." + PstDepartment.fieldNames[PstDepartment.FLD_DEPARTMENT] + " FROM "
    ...
    private static void resultToObject(ResultSet rs, Location location) {
        try {
            ...
            //add by de Koyo
            location.setLocationUsedTable(rs.getInt(PstLocation.fieldNames[PstLocation.FLD_LOCATION_USED_TABLE]));

            location.setServiceView(rs.getDouble(PstLocation.fieldNames[PstLocation.FLD_SERVICE_VIEW]));
            location.setTaxView(rs.getDouble(PstLocation.fieldNames[PstLocation.FLD_TAX_VIEW]));
            ...
            location.setStandardRateId(rs.getLong(PstLocation.fieldNames[PstLocation.FLD_STANDART_RATE_ID]));
