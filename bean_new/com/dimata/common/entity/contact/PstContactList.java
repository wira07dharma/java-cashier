...
public class PstContactList extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_NO_NPWP = 68;
    public static final int FLD_NO_KARTU_KELUARGA = 69;
    public static final int FLD_MEMBER_COMP_CITY = 70;
    ...
    public static ContactList fetchExc(long oid) throws DBException {
        try {
            ...
            //new
                ...
                contactlist.setNoNpwp(pstContactList.getString(FLD_NO_NPWP));
                contactlist.setNoKartuKeluarga(pstContactList.getString(FLD_NO_KARTU_KELUARGA));
                contactlist.setMemberCompCity(pstContactList.getlong(FLD_MEMBER_COMP_CITY));
    ...
    public static long insertExc(ContactList contactlist) throws DBException {
        try {
            ...
            pstContactList.setString(FLD_NO_NPWP, contactlist.getNoNpwp());
            pstContactList.setString(FLD_NO_KARTU_KELUARGA, contactlist.getNoKartuKeluarga());
            pstContactList.setLong(FLD_MEMBER_COMP_CITY, contactlist.getMemberCompCity());
    ...
    public static void resultToObject(ResultSet rs, ContactList contactlist) {
        try {
            ...
            contactlist.setNoNpwp(rs.getString(PstContactList.fieldNames[PstContactList.FLD_NO_NPWP]));
            contactlist.setNoKartuKeluarga(rs.getString(PstContactList.fieldNames[PstContactList.FLD_NO_KARTU_KELUARGA]));
            contactlist.setMemberCompCity(rs.getLong(PstContactList.fieldNames[PstContactList.FLD_MEMBER_COMP_CITY]));
...
//            System.out.println("---------------- sql cekCodeContact : "+sql);
    ...
    /**
     * list contact depent on contactType, contactCode and contactName modifield
     * by : gedhy modifield at : July 08, 2003 13:30 pm
     */
