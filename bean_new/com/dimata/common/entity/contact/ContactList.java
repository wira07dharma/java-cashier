...
public class ContactList extends Entity implements Serializable {
    ...
    /**
     * @return the memberCompCity
     */
    public long getMemberCompCity() {
        return memberCompCity;
    }

    /**
     * @param memberCompCity the memberCompCity to set
     */
    public void setMemberCompCity(long memberCompCity) {
        this.memberCompCity = memberCompCity;
    }
