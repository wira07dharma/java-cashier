...

{
    ...
    /**
     * Update sysprop, jika tidak ketemu maka di insert
     * @param sysProp
     * @return
     */
    public static long updateInsertByName(SystemProperty sysProp){
        if(sysProp==null || sysProp.getName()==null || sysProp.getName().length()<1){
            return 0;
        }
        try{
        Vector v = list(0, 1, fieldNames[FLD_NAME]+"=\""+sysProp.getName()+"\"", "");
        if(v!=null && v.size()>0){
          SystemProperty sysPropOld = (SystemProperty)  v.get(0);
          sysProp.setOID(sysPropOld.getOID());
          long l = update(sysProp);
        }else{
           long l = insert(sysProp);
           sysProp.setOID(l);
        }
        } catch(Exception exc){
    ...
    public static long InsertByName(SystemProperty sysProp){
        if(sysProp==null || sysProp.getName()==null || sysProp.getName().length()<1){
            return 0;
        }
        try{
...

    {
        ...
        try {
            ...
            ResultSet rs =dbrs.getResultSet();// execQuery(sql);
    ...
    public static boolean getBoolean(String propertyName){
        try{
            return Boolean.parseBoolean(getValueByName(propertyName));
        }catch(Exception exc){
            System.out.println("EXC : "+ propertyName +" >>>");
            return false;
        }
    }

    /**
     * @author Kartika 8 Mei 2013
     * @param name
     * @return
     */
    ...
    public static double getDoubleProperty(String name){
        try{
            return Double.parseDouble(getValueByName(name));
        }catch(Exception exc){
            return 0;
        }
    }
    ...
    public static String getValueByNameVersiDua(String name)
    ...
    public static String getValueByNameVersiTiga(String name)
    {
