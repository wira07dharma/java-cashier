...
public class FrmBillMain extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_SHIPPING_DATE = 56;
    public static final int FRM_FIELD_FLIGHT_NUMBER = 57;
    public static final int FRM_FIELD_APP_USER_SALES_ID = 58;
    public static final int FRM_FIELD_ADMIN_FEE = 59;
    public static final int FRM_FIELD_SHIPPING_FEE = 60;
    ...
    public static String[] fieldNames
            = {
                ...
                "FRM_FIELD_ID_NEGARA",
                "FRM_FIELD_GENDER",
                "FRM_FIELD_SHIPPING_DATE",
                "FRM_FIELD_FLIGHT_NUMBER",
    ...
    public BillMain getEntityObject() {
        return billMain;
    }
    ...
    public void requestEntityObject(BillMain billMain) {
        try {
            ...
            billMain.setReservasiId(getLong(FRM_FIELD_RESERVATION_ID));
            billMain.setNegaraId(getLong(FRM_FIELD_ID_NEGARA));
            billMain.setGender(getInt(FRM_FIELD_GENDER));
            billMain.setShippingDate(Formater.formatDate(getString(FRM_FIELD_SHIPPING_DATE), "yyyy/MM/dd HH:mm:ss"));
            billMain.setFlightNumber(getString(FRM_FIELD_FLIGHT_NUMBER));
            billMain.setAppUserSalesId(getLong(FRM_FIELD_APP_USER_SALES_ID));
            billMain.setAdminFee(getLong(FRM_FIELD_ADMIN_FEE));
            billMain.setShippingFee(getLong(FRM_FIELD_SHIPPING_FEE));
        } catch (Exception e) {
