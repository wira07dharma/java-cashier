...
public class FrmCashPayment extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_AMOUNT_GUIDE_PRICE = 10;
    ...
    public CashPayments1 getEntityObject() {
        return cashPayment;
    }
    ...
    public void requestEntityObject(CashPayments1 cashPayment) {
        try {
            ...
            cashPayment.setAmountGuidePrice(getDouble(FRM_FIELD_AMOUNT_GUIDE_PRICE));
        } catch (Exception e) {
