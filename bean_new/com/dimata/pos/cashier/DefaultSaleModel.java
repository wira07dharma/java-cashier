...
public class DefaultSaleModel {
    ...
    public void setSalesPerson(Sales salesPerson) {
        ...
        this.getMainSale().setAppUserSalesId(salesPerson.getOID());
     ...
     * @param salesPerson New value of property salesPerson.
     */
    public void setUserSalesPerson(AppUser userSalesPerson) {
        
        this.userSalesPerson = userSalesPerson;
        this.getMainSale().setAppUserSalesId(userSalesPerson.getOID());
...
//            this.setSalesPerson(salesPerson);
            AppUser salesPerson = PstAppUser.fetch(pendingOrder.getSalesId());
            this.setUserSalesPerson(salesPerson);
            this.getMainSale().setAppUserSalesId(salesPerson.getOID());
        }
        catch(Exception e){
            System.out.println("Err transferFromPendingOrder: "+e.toString());
