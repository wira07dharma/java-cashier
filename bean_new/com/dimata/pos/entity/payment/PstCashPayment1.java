...
public class PstCashPayment1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    //added by dewok 20191127 for guide price tabanan
    public static final int FLD_AMOUNT_GUIDE_PRICE = 8;
    ...
    public static CashPayments1 fetchExc(long oid) throws DBException {
        try {
            ...
            cashPayment1.setAmountGuidePrice(pstCashPayment1.getdouble(FLD_AMOUNT_GUIDE_PRICE));
    ...
    public static long insertExc(CashPayments1 cashPayment1) throws DBException {
        try {
            ...
            pstCashPayment1.setDouble(FLD_AMOUNT_GUIDE_PRICE, cashPayment1.getAmountGuidePrice());
    ...
    /**
     * Ari_wiweka 20130727 Menampilkan list cash payment di Multiple Payment
     *
     * @param rs
     * @param cashCashier
     */
    ...
    /**
     * Ari_wiweka 20130728 sum total payment
     */
    ...
    /**
     * Ari_wiweka 20130727 Count untuk list cah payment
     *
     * @param rs
     * @param cashPayment1
     */
    ...
    public static void resultToObject(ResultSet rs, CashPayments1 cashPayment1) {
        try {
            ...
            cashPayment1.setAmountGuidePrice(rs.getDouble(PstCashPayment1.fieldNames[PstCashPayment1.FLD_AMOUNT_GUIDE_PRICE]));
    ...
    /**
     * overloading method getListPayment(lLocationOid, dStartDate, dEndDate,
     * iDocType, iSaleReportType)
     */
    ...
    public Vector getListPaymentDinamis2(long lCashBillMainOid) {
        Vector result = new Vector(1, 1);
        DBResultSet dbrs = null;
        try {
            String sSQLPayment = "SELECT P." + PstCashPayment.fieldNames[PstCashPayment.FLD_PAYMENT_ID]
                    + ", P." + PstCashPayment.fieldNames[PstCashPayment.FLD_PAY_TYPE]
                    + ", P." + PstCashPayment.fieldNames[PstCashPayment.FLD_CURRENCY_ID]
                    + ", P." + PstCashPayment.fieldNames[PstCashPayment.FLD_RATE]
                    + ", SUM(P." + PstCashPayment.fieldNames[PstCashPayment.FLD_AMOUNT] + ")"
                    + "/P." + PstCashPayment.fieldNames[PstCashPayment.FLD_RATE] + " AS " + PstCashPayment.fieldNames[PstCashPayment.FLD_AMOUNT] + ""
                    + " FROM " + PstCashPayment.TBL_PAYMENT + " AS P "
                    + " INNER JOIN " + PstBillMain.TBL_CASH_BILL_MAIN + " AS BM "
                    + " ON P." + PstCashPayment.fieldNames[PstCashPayment.FLD_BILL_MAIN_ID]
                    + " = BM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
            ...
            String sSQLChange = "SELECT 0 AS " + PstCashPayment.fieldNames[PstCashPayment.FLD_PAYMENT_ID]
                    + ", 0 AS " + PstCashPayment.fieldNames[PstCashPayment.FLD_PAY_TYPE]
                    + ", C." + PstCashReturn.fieldNames[PstCashReturn.FLD_CURRENCY_ID]
                    + ", C." + PstCashReturn.fieldNames[PstCashReturn.FLD_RATE]
                    + ", - SUM(C." + PstCashReturn.fieldNames[PstCashReturn.FLD_AMOUNT] + ") AS " + PstCashReturn.fieldNames[PstCashReturn.FLD_AMOUNT] + ""
                    + " FROM " + PstBillMain.TBL_CASH_BILL_MAIN + " AS M "
                    + " INNER JOIN " + PstCashReturn.TBL_RETURN + " AS C "
                    + " ON M." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
                    + " = C." + PstCashReturn.fieldNames[PstCashReturn.FLD_BILLMAIN_ID]
            ...
            while (rs.next()) {
                CashPayments1 objCashPaymentsDinamis = new CashPayments1();
                objCashPaymentsDinamis.setOID(rs.getLong(PstCashPayment.fieldNames[PstCashPayment.FLD_PAYMENT_ID]));
                objCashPaymentsDinamis.setPaymentType(rs.getLong(PstCashPayment.fieldNames[PstCashPayment.FLD_PAY_TYPE]));
                objCashPaymentsDinamis.setCurrencyId(rs.getLong(PstCashPayment.fieldNames[PstCashPayment.FLD_CURRENCY_ID]));
                objCashPaymentsDinamis.setRate(rs.getDouble(PstCashPayment.fieldNames[PstCashPayment.FLD_RATE]));
                objCashPaymentsDinamis.setAmount(rs.getDouble(PstCashPayment.fieldNames[PstCashPayment.FLD_AMOUNT]));
    ...
    public static Vector listDetailPaymentDinamisWithReturn(int limitStart, int recordToGet, String whereClause) {
        ...
        try {
            String sql = "SELECT " + fieldNames[FLD_PAY_TYPE]
                    ...
                    + //Add Transaction type and transaction status
                    " AND " + PstBillMain.fieldNames[PstBillMain.FLD_TRANSCATION_TYPE] + "=0"
                    + " AND (" + PstBillMain.fieldNames[PstBillMain.FLD_TRANSACTION_STATUS] + "=0 OR "
                    + PstBillMain.fieldNames[PstBillMain.FLD_TRANSACTION_STATUS] + "=3 )"
                    + //" AND " + PstBillMain.fieldNames[PstBillMain.FLD_TRANSACTION_STATUS] + "!=2" +
                    " GROUP BY " + fieldNames[FLD_PAY_TYPE]
                    + ", CP." + fieldNames[FLD_CURRENCY_ID]
                    + ", CP." + fieldNames[FLD_RATE];
    ...
    public static Vector listDetailPaymentSalesWithCashReturn(int limitStart, int recordToGet, String whereClause) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT " + fieldNames[FLD_PAY_TYPE]
    ...
    public static Vector listDetailPaymentSalesReturnWithCashReturn(int limitStart, int recordToGet, String whereClause) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT " + fieldNames[FLD_PAY_TYPE]
    ...
    /**
     * Ari_wiweka20130729 untuk SUM Credit card, cheque, cash , dan debit card
     * yang di inputkan dari multiple payment
     */
    ...
    public static double getSumSystemPaymentWithBillStatus(String whereClause) {
        double count = 0;
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT SUM(CP." + fieldNames[PstCashPayment1.FLD_AMOUNT] + ")  "
                    ...
                    + " ON CP." + fieldNames[PstCashPayment1.FLD_BILL_MAIN_ID] + " = "
                    + " CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
                    + " WHERE ("
                    + "("
                    + "CBM." + PstBillMain.fieldNames[PstBillMain.FLD_DOC_TYPE] + "='0' "
    ...
    public static double getSumBillAmountWithBillStatus(String whereClause) {
        double count = 0;
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT SUM(CBM." + PstBillMain.fieldNames[PstBillMain.FLD_AMOUNT] + ")  "
                    + " FROM " + TBL_PAYMENT + " AS CP "
                    + " LEFT JOIN " + PstPaymentSystem.TBL_P2_PAYMENT_SYSTEM + " AS PS"
                    + " ON CP." + fieldNames[PstCashPayment1.FLD_PAY_TYPE] + " = "
                    + " PS." + PstPaymentSystem.fieldNames[PstPaymentSystem.FLD_PAYMENT_SYSTEM_ID]
    ...
    public static double getSumSystemPaymentWithReturnAndBillStatus(String whereClause) {
        double count = 0;
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT SUM(CP." + fieldNames[FLD_AMOUNT] + " - CRP." + PstCashReturn.fieldNames[PstCashReturn.FLD_AMOUNT] + ")  "
                    + " FROM " + TBL_PAYMENT + " AS CP "
                    + " LEFT JOIN " + PstPaymentSystem.TBL_P2_PAYMENT_SYSTEM + " AS PS"
                    + " ON CP." + fieldNames[PstCashPayment1.FLD_PAY_TYPE] + " = "
                    + " PS." + PstPaymentSystem.fieldNames[PstPaymentSystem.FLD_PAYMENT_SYSTEM_ID]
                    ...
                    + " ON CP." + fieldNames[PstCashPayment1.FLD_BILL_MAIN_ID] + " = "
                    + " CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
                    + " INNER JOIN " + PstCashReturn.TBL_RETURN + " AS CRP"
                    + " ON CRP." + PstCashReturn.fieldNames[PstCashReturn.FLD_BILLMAIN_ID] + " = "
                    + " CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
                    + " LEFT JOIN " + PstBillMain.TBL_CASH_BILL_MAIN + " AS CPM "
                    + " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_PARENT_ID] + " = "
                    + " CPM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]
                    + " WHERE ("
                    + "("
                    + "CBM." + PstBillMain.fieldNames[PstBillMain.FLD_DOC_TYPE] + "='0' "
                    + "AND CBM." + PstBillMain.fieldNames[PstBillMain.FLD_TRANSCATION_TYPE] + "='0' "
    ...
    public static double getSumPaymentReturn(String whereClause) {
        double count = 0;
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT SUM(CP." + fieldNames[FLD_AMOUNT] + " - CRP." + PstCashReturn.fieldNames[PstCashReturn.FLD_AMOUNT] + ")  "
