...
public class PstCashCreditPayment extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
	...
	public static String getInsertSQL(CashCreditPayments cashCreditPayment){
		String sql = "";
		try {
			PstCashCreditPayment pstCashCreditPayment = new PstCashCreditPayment(cashCreditPayment.getOID());
			sql = pstCashCreditPayment.getInsertSQL();
		} catch (Exception exc){
