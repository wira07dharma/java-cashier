            ...
            switch (srcSaleReport.getQueryType()) {
                ...
                case SrcSaleReport.GROUP_BY_SALES:
                    sql = "SELECT " +
                            ...
                            " mat." + PstMaterial.fieldNames[PstMaterial.FLD_NAME] + "," +
                            " cbd." + PstBillDetail.fieldNames[PstBillDetail.FLD_QUANTITY] + "," +
                            " sps." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] + "," +
                            " sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + "," +
...
//                            " sps." + PstSales.fieldNames[PstSales.FLD_NAME] + "," +
                            ...
                            " inner join " +
                            " pos_app_user as sps" +
                            " on sps.user_id = cbm.app_user_id)" +
                            " inner join pos_material as mat" +
                            " on mat.material_id= cbd.material_id)";
                    break;
            ...
            switch (srcSaleReport.getQueryType()) {
                ...
                case SrcSaleReport.GROUP_BY_SALES:
                    if (srcSaleReport.getSalesPersonId() != 0) {
                        salesPersonId = " sps." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] + "=" + srcSaleReport.getSalesPersonId();
                    }
                    break;
//                case SrcSaleReport.GROUP_BY_SALES:
//                    if (srcSaleReport.getSalesPersonId() != 0) {
...
//                    break;
           ...
           // }
            ...
            switch (srcSaleReport.getGroupBy()) {
                ...
                case SrcSaleReport.GROUP_BY_SALES:
                    sql = sql + "\n  group by sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME];
                    break;
//                    
//                case SrcSaleReport.GROUP_BY_SALES:
...
//                    break;
            ...
            switch (srcSaleReport.getSortBy()) {
                ...
                case SrcSaleReport.SORT_BY_SALES_PERSON:
                    sql = sql + "\n  order by sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + " " + descSort + " ";
                    break;
//                    
//                case SrcSaleReport.SORT_BY_SALES_PERSON:
...
//                    break;
            ...
            while (rs.next()) {
                ...
                if (srcSaleReport.getGroupBy() == SrcSaleReport.GROUP_BY_SALES) {
                    item.setSalesPersonId(rs.getLong("sps." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] + ""));
                    item.setSalesPersonName(rs.getString("sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + ""));
                }
...
//                            " sps." + PstSales.fieldNames[PstSales.FLD_NAME] + "," +
                            ...
                            " inner join " +
                            " pos_app_user as sps" +
                            " on sps.user_id = cbm.app_user_is)" +
                            " inner join pos_material as mat" +
                            " on mat.material_id= cbd.material_id)";
                    break;
                ...
                for (int i = 0; i < srcSaleReport.getViewColoumChange().size(); i++) {
                    ...
                    switch (coloum) {
                        ...
                        case SrcSaleReport.SHOW_FIELD_SALES_NAME:
                            sql = sql + ", sps." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] + "," +
                                    " sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME];
                            break;
//                        case SrcSaleReport.SHOW_FIELD_SALES_NAME:
                ...
                for (int i = 0; i < srcSaleReport.getViewColoumChange().size(); i++) {
                    ...
                    switch (coloum) {
                        ...
                        case SrcSaleReport.SHOW_FIELD_SUPPLIER:
                            ...
                            break;
                        case SrcSaleReport.SHOW_FIELD_SALES_NAME:
                            sql = sql + ", sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME];
                            break;
//                        case SrcSaleReport.SHOW_FIELD_SALES_NAME:
...
//                            break;
            ...
            switch (srcSaleReport.getSortBy()) {
                ...
                case SrcSaleReport.SHOW_FIELD_SUPPLIER:
                    ...
                    break;
                case SrcSaleReport.SHOW_FIELD_SALES_NAME:
                    sql = sql + " order by sps." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME];
                    break;
//                case SrcSaleReport.SHOW_FIELD_SALES_NAME:
...
//                                break;
    ...
    public static Vector getListReportVoid(SrcSaleReport srcSaleReport, int start, int recordToGet, int logMode) {
        ...
        sql = "SELECT cbm.*, cbd."+PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NO]+" FROM "+PstBillDetailVoid.TBL_CASH_BILL_DETAIL+" AS cbm INNER JOIN "+PstBillMain.TBL_CASH_BILL_MAIN+ " AS cbd ON "+
    ...
    public static Vector getListReportError(SrcSaleReport srcSaleReport, int start, int recordToGet, int logMode) {
        ...
        sql = "SELECT cbm.*, cbd."+PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NO]+" FROM "+PstBillDetail.TBL_CASH_BILL_DETAIL+" AS cbm INNER JOIN "+PstBillMain.TBL_CASH_BILL_MAIN+ " AS cbd ON "+
              " cbm."+PstBillDetail.fieldNames[PstBillDetailVoid.FLD_BILL_MAIN_ID]+"= cbd."+PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID];
        ...
        if (srcSaleReport.getDateFrom() != null) {
         ...
         sql = sql + " AND cbm."+PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_PRICE]+"='0'";
    ...
    public static Vector getListReportCancel(SrcSaleReport srcSaleReport, int start, int recordToGet, int logMode) {
        ...
        sql = "SELECT cbm.*, cbd."+PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NO]+", cbd."+PstBillMain.fieldNames[PstBillMain.FLD_NOTES]+" FROM "+PstBillDetailVoid.TBL_CASH_BILL_DETAIL+" AS cbm INNER JOIN "+PstBillMain.TBL_CASH_BILL_MAIN+ " AS cbd ON "+
              " cbm."+PstBillDetailVoid.fieldNames[PstBillDetailVoid.FLD_BILL_MAIN_ID]+"= cbd."+PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID];
        ...
        sql = sql + " AND cbd.DOC_TYPE=0 AND cbd.TRANSACTION_STATUS=2 AND cbd.TRANSACTION_TYPE=0 ";
