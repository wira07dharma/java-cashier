    ...
    public static Vector listPO(int limitStart, int recordToGet, String whereClause) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                poitem.setCurrencyId(rs.getLong(10));
                poitem.setDiscount(rs.getDouble(11)/rs.getDouble(31));
                poitem.setDiscount1(rs.getDouble(12)/rs.getDouble(31));
                poitem.setDiscount2(rs.getDouble(13)/rs.getDouble(31));
                poitem.setDiscNominal(rs.getDouble(14)/rs.getDouble(31));
