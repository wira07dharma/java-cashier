...
public class PstMatDispatch extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_Document {
    ...
    public static final int FLD_STATUS_DRAFT = 0;
    public static final int FLD_STATUS_TO_BE_APPROVED = 1;
    public static final int FLD_STATUS_FINAL = 2;
    public static final int FLD_STATUS_CLOSED = 5;
    public static final int FLD_STATUS_POSTED = 7;
    
    public static final String[] fieldTypeStatus = {
            "Draft",
            "To Be Approved",
            "Final",
            "",
	...
	public static String getInsertSQL(MatDispatch matdispatch){
		String sql = "";
		try {
			PstMatDispatch pstMatDispatch = new PstMatDispatch(matdispatch.getOID());
			sql = pstMatDispatch.getInsertSQL();
		} catch (Exception exc){
    ...
    public static long autoInsertPoFromPr(Vector list, Vector listPr,  long vSelected) {
        ...
        try {
		    ...
		    purchOrder.setDispatchCodeCounter(maxCounter);
                    purchOrder.setDispatchCode(SessMatDispatch.generateDispatchCode(purchOrder));
