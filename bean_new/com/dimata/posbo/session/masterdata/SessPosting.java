...
public class SessPosting {
            ...
            while (rs.next()) {
                ...
                try {
                    //vErrUpdateStockByReceiveItem = updateStockByReceiveItem(lPeriodeOid, oidLocation, oidRM, recSource, ppn);
                     vErrUpdateStockByReceiveItem = updateStockByReceiveItem(lPeriodeOid, oidLocation, oidRM, recSource, ppn, includePpn);
                }
                catch(Exception e) {
    ...
    public boolean postedReceiveDoc(long oidRec){
        ...
        try{
            ...
            Vector vErrUpdateStockByReceiveItem = updateStockByReceiveItem(periode.getOID(), matReceive.getLocationId(), matReceive.getOID(), matReceive.getReceiveSource(), matReceive.getTotalPpn(), matReceive.getIncludePpn());
     ...
     * @return
     */
    public boolean postedReturnDoc(long oidRet){
        boolean isOK = false;
        try{
   ...
   public boolean postedSalesTranscaction(long oidBillMain){
    ...
    //private Vector updateStockByReceiveItem(long oidPeriode, long oidLocation, long lReceiveMaterialOid, int recSource, double ppn) {
      private Vector updateStockByReceiveItem(long oidPeriode, long oidLocation, long lReceiveMaterialOid, int recSource, double ppn, int includePpn) {
        DBResultSet dbrs = null;
        Vector vResult = new Vector(1, 1);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                boolean isOK = false;
                if ((recSource == PstMatReceive.SOURCE_FROM_SUPPLIER) ||(recSource == PstMatReceive.SOURCE_FROM_SUPPLIER_PO || recSource == PstMatReceive.SOURCE_FROM_DISPATCH_UNIT )) {
