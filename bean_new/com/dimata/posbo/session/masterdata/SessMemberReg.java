...
import java.sql.ResultSet;
  ...
  public class  SessMemberReg  {
    ...
    //2017132
    public static Vector memberPoin(int limitStart, int recordToGet, String whereClause, String order) {
        Vector result = new Vector(1, 1);
        DBResultSet dbrs = null;
        try {
            ...
            String sql = " SELECT MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_CODE] +
                    ...
                    ", MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_CREDIT_LIMIT] +
                    ", MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_NATIONALITY] +
                    ", MRH."+PstMemberRegistrationHistory.fieldNames[PstMemberRegistrationHistory.FLD_VALID_EXPIRED_DATE]+""+
                    " FROM " + PstMemberReg.TBL_CONTACT_LIST + " AS MBR " +
                    " INNER JOIN " + PstContactClassAssign.TBL_CNT_CLS_ASSIGN + " AS ASG " +
                    " ON MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_ID] +
                    " = ASG." + PstContactClassAssign.fieldNames[PstContactClassAssign.FLD_CONTACT_ID] +
                    ...
                    " ON MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_GROUP_ID] +
                    " = GRP." + PstMemberGroup.fieldNames[PstMemberGroup.FLD_MEMBER_GROUP_ID] +""+
                    " INNER JOIN `"+PstMemberRegistrationHistory.TBL_MEMBER_REGISTRATION_HISTORY+"` MRH\n" +
                    "  ON MRH.`"+PstMemberRegistrationHistory.fieldNames[PstMemberRegistrationHistory.FLD_MEMBER_ID]+"` "
                    + " = MBR.`"+ PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_ID] +"`";
    
            whereClause +=" CLS." + PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE] +
                    " = " + PstContactClass.CONTACT_TYPE_MEMBER + " AND MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_PROCESS_STATUS] +
                    " != " + PstMemberReg.DELETE+"";
            ...
            while (rs.next()) {
                ...
                data.put("CONTACT_CODE",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_CODE]));
                data.put("CONTACT_ID",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_ID]));
                data.put("PERSON_NAME",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_PERSON_NAME]));
                data.put("HOME_ADDR",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_HOME_ADDR]));
                data.put("HOME_TELP",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_HOME_TELP]));
                data.put("TELP_MOBILE",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_TELP_MOBILE]));
                data.put("HOME_FAX",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_HOME_FAX]));
                data.put("HOME_TOWN",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_HOME_TOWN]));
                data.put("MEMBER_BARCODE",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_BARCODE]));
                data.put("MEMBER_BIRTH_DATE",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_BIRTH_DATE]));
                data.put("MEMBER_COUNTER",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_COUNTER]));
                data.put("MEMBER_GROUP_ID",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_GROUP_ID]));
                data.put("MEMBER_ID_CARD_NUMBER",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_ID_CARD_NUMBER]));
                data.put("MEMBER_LAST_UPDATE",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_LAST_UPDATE]));
                data.put("MEMBER_RELIGION_ID",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_RELIGION_ID]));
                data.put("MEMBER_SEX",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_SEX]));
                data.put("MEMBER_STATUS",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_STATUS]));
                data.put("COMP_NAME",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_COMP_NAME]));
                data.put("BUSS_ADDRESS",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_BUSS_ADDRESS]));
                data.put("CONSIGMENT_LIMIT",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_CONSIGMENT_LIMIT]));
                data.put("CREDIT_LIMIT",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_CREDIT_LIMIT]));
                data.put("NATIONALITY",rs.getString(PstMemberReg.fieldNames[PstMemberReg.FLD_MEMBER_NATIONALITY]));
                
                data.put("RELIGION",rs.getString(PstReligion.fieldNames[PstReligion.FLD_RELIGION]));
                
                data.put("NAME",rs.getString(PstMemberGroup.fieldNames[PstMemberGroup.FLD_CODE]));
                data.put("CODE",rs.getString(PstMemberGroup.fieldNames[PstMemberGroup.FLD_NAME]));
                data.put("GROUP_TYPE",rs.getString(PstMemberGroup.fieldNames[PstMemberGroup.FLD_GROUP_TYPE]));
                
                data.put("VALID_EXPIRED_DATE", rs.getString(PstMemberRegistrationHistory.fieldNames[PstMemberRegistrationHistory.FLD_VALID_EXPIRED_DATE]));
    ...
    public static Vector searchMemberDeliveryOrder(SrcMemberReg srcmemberreg, int start, int recordToGet) {
        ...
        try {
            ...
            String sql = " SELECT MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_CONTACT_CODE] +
                    ...
                    " = CLS." + PstContactClass.fieldNames[PstContactClass.FLD_CONTACT_CLASS_ID] +
                    " WHERE CLS." + PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE] +
                    " = " + PstContactClass.CONTACT_TYPE_DELIVERY_MEMBER + " AND MBR." + PstMemberReg.fieldNames[PstMemberReg.FLD_PROCESS_STATUS] +
                    " != " + PstMemberReg.DELETE;
