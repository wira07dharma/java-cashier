    ...
    public static Vector getReportSale(SrcReportSale srcReportSale) {
        ...
        try {   
            ...
            String sql = " SELECT " +
                    ...
                    ", SLS." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // sales_name" + New Peralihan 2020-01-03
                    " AS SLS_" + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // sales_name" +
...
//                    " AS SLS_" + PstSales.fieldNames[PstSales.FLD_NAME] + // sales_name" +
                    ...
                    " ) LEFT JOIN " + PstAppUser.TBL_APP_USER + " SLS" + // sales_person
                    " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_APPUSER_ID] + // SALES_CODE" +
                    " = SLS." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID]; // SALES_CODE";
...
//                    " = SLS." + PstSales.fieldNames[PstSales.FLD_CODE]; // SALES_CODE";
            ...
            while (rs.next()) {
                ...
                sls.setName(rs.getString("SLS_" + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME]));
                temp.add(sls);
    ...
    public static Vector getReportSaleNew(SrcReportSale srcReportSale) {
        ...
        try {   
            String sql = " SELECT " +
                    ...
                    " AS SLS_" + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] +
//                    ", SLS." + PstSales.fieldNames[PstSales.FLD_NAME] + // sales_name" +
//                    " AS SLS_" + PstSales.fieldNames[PstSales.FLD_NAME] + // sales_name" +
                    ", CBM." + PstBillMain.fieldNames[PstBillMain.FLD_SERVICE_VALUE] +
                    ", CBM." + PstBillMain.fieldNames[PstBillMain.FLD_TAX_VALUE] +
                    ...
                    " ON CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_UNIT_ID] + // UNIT_ID" +
                    " = UNT." + PstUnit.fieldNames[PstUnit.FLD_UNIT_ID] + //UNIT_ID" +
                    " ) LEFT JOIN " + PstAppUser.TBL_APP_USER + " SLS" + // app_user
                    " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_APPUSER_ID] + // APP_USER_ID" +
                    " = SLS." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID]; // USER_ID
//                    " ) LEFT JOIN " + PstSales.TBL_SALES + " SLS" + // sales_person
//                    " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_SALES_CODE] + // SALES_CODE" +
//                    " = SLS." + PstSales.fieldNames[PstSales.FLD_CODE]; // SALES_CODE";
            ...
            while (rs.next()) {
                ...
                sls.setName(rs.getString("SLS_" + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID]));
                temp.add(sls);
    ...
    public static Vector getReportSaleRekapInvoice(SrcReportSale srcReportSale) {
        ...
        try {
            String sql = "SELECT " +
                    ...
                    ", USR." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // FULL_NAME" +
//                    ", SLS." + PstSales.fieldNames[PstSales.FLD_NAME] + // SALES_NAME" +
                    ", SLS." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // SALES_NAME" +
...
//                    " = SLS." + PstSales.fieldNames[PstSales.FLD_CODE]; // SALES_CODE";
            ...
            while (rs.next()) {
                ...
                temp.add(new Double(rs.getDouble("DISC")));
                temp.add(rs.getString(PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME]));
                temp.add(rs.getString(PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME]));//Peralihan Sales Person
    ...
    public static Vector getReportSaleRekapInvoiceByDoc(SrcReportSale srcReportSale) {
        ...
        try {
            ...
            String sql = "SELECT " +
                    ...
                    ") - CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_PRICE] + ") AS DISC" + // TOTAL_PRICE
                    ", USR." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // FULL_NAME" +
                    ", SLS." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] + // FULL_NAME" +
//                    ", SLS." + PstSales.fieldNames[PstSales.FLD_NAME] + // SALES_NAME" +
                    ", CBM." + PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NUMBER] + // INVOICE_NUMBER
                    " FROM ((((((" + PstBillMain.TBL_CASH_BILL_MAIN + " CBM" + // cash_bill_main
                    " INNER JOIN " + PstBillDetail.TBL_CASH_BILL_DETAIL + " CBD" + // cash_bill_detail
                    ...
                    " ON CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_UNIT_ID] + // UNIT_ID" +
                    " = UNT." + PstUnit.fieldNames[PstUnit.FLD_UNIT_ID] + // UNIT_ID" +
                    " ) INNER JOIN " + PstAppUser.TBL_APP_USER + " SLS" + // app_user
                    " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_APPUSER_ID] + // APP_USER_ID
                    " = SLS." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID]; // USER_ID" +
//                    " ) LEFT JOIN " + PstSales.TBL_SALES + " SLS" + // sales_person
//                    " ON CBM." + PstBillMain.fieldNames[PstBillMain.FLD_SALES_CODE] + // SALES_CODE
    ...
    public static Vector getReportPerSales(SrcReportSale srcReportSale) {
        ...
        try {
            String sql = "SELECT " +
                    ...
                    " ,SALES." + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] +
                    " AS SALES_" + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME] +
...
//                    " AS SALES_" + PstSales.fieldNames[PstSales.FLD_NAME] +
                    ...
                    ") LEFT JOIN " + PstAppUser.TBL_APP_USER + " AS SALES " +
                    " ON SALES." + PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] +
                    " = MAIN." + PstBillMain.fieldNames[PstBillMain.FLD_APPUSER_ID] +
...
//                    " = MAIN." + PstBillMain.fieldNames[PstBillMain.FLD_SALES_CODE] +
            ...
            while (rs.next()) {
                ...
                temp.add(rs.getString("SALES_" + PstAppUser.fieldNames[PstAppUser.FLD_FULL_NAME]));
