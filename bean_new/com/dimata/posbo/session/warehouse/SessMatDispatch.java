...
public class SessMatDispatch extends Control {
	...
	if (srcMatDispatch != null) {
		...
		statusDelivery = "(DF." + PstMatDispatch.fieldNames[PstMatDispatch.FLD_CASH_BILL_MAIN_ID] + " !='0')";
                ...
                statusDelivery = "(DF." + PstMatDispatch.fieldNames[PstMatDispatch.FLD_CASH_BILL_MAIN_ID] + " ='0' OR DF." + PstMatDispatch.fieldNames[PstMatDispatch.FLD_CASH_BILL_MAIN_ID] + " ='NULL')";
            }
