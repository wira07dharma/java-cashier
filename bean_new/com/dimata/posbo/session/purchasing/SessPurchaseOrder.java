    ...
    public static Vector getPurchaseOrderMaterialList(String className, int docType, Vector vectNumber, Vector vectVendor, SrcPurchaseOrder srcpurchaseorder, int start, int recordToGet, long oidVendor, String whereLocation) {
        ...
        try {
            ...
            switch (srcpurchaseorder.getSortby()) {
                case 0:
                    sql = sql + " ORDER BY MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PO_CODE]+", MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PURCH_DATE]+" DESC ";
                    break;
                case 1:
                     sql = sql + " ORDER BY MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PO_CODE]+", MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PURCH_DATE]+" DESC ";
                    break;
                case 2:
                    sql = sql + " ORDER BY MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PO_STATUS]+", MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PURCH_DATE]+" DESC ";
                    break;
                case 3:
                    sql = sql + " ORDER BY CNT." + PstContactList.fieldNames[PstContactList.FLD_COMP_NAME]+", MAT." + PstPurchaseOrder.fieldNames[PstPurchaseOrder.FLD_PURCH_DATE]+" DESC ";
                    break;
            }
