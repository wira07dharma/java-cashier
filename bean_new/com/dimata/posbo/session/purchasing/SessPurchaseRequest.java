...
//           }
    ...
    public static Vector getPurchaseRequestForPo(HttpServletRequest request){
     ...
     public static Vector getListMaterialFromPRForPO(String whereClause) {
         ...
         DBResultSet dbrs = null;
         try{
          String sql =  " SELECT LC.NAME,PM.SKU,PM.NAME, PRI.MATERIAL_ID, PRI.UNIT_REQUEST_ID,PRI.QTY,PM.SKU, PRI.PURCHASE_REQUEST_ITEM_ID  "+
          ...
          dbrs = DBHandler.execQueryResult(sql);
           ...
           while (rs.next()) {
                ...
                material.setDefaultStockUnitId(rs.getLong("PRI.UNIT_REQUEST_ID"));
                v3.add(material);
     ...
     public static Vector getListMaterialFromPRForPOFilter(Vector listMaterial,Vector vectMaterialListFilter) {
         ...
         for(int i=0; i<vectMaterialListFilter.size(); i++){
            ...
            double qty = getOidMaterialByVector(listMaterial,material.getOidMaterial());
     ...
     public static double getOidMaterialByVector(Vector list, long oidMaterial){
      ...
      public static Vector getFilterListMaterialFromPRForPO(String whereClause) {
         ...
         DBResultSet dbrs = null;
         try{
          String sql =  " SELECT DISTINCT PM.SKU, PM.NAME, PRI.UNIT_ID, PRI.MATERIAL_ID, PRI.UNIT_REQUEST_ID, PRI.SUPPLIER_ID,PRI.PRICE_BUYING,PRI.TOTA_PRICE_BUYING, PU.NAME, PRI.SUPPLIER_NAME, PRI.TERM_PURCHASE_REQUEST, PRI.PURCHASE_REQUEST_ITEM_ID "+
                        " FROM "+PstPurchaseRequestItem.TBL_PURCHASE_REQUEST_ITEM+" AS PRI "+
                        " INNER JOIN "+PstPurchaseRequest.TBL_PURCHASE_REQUEST+" AS PR "+
                        " ON PR."+PstPurchaseRequest.fieldNames[PstPurchaseRequest.FLD_PURCHASE_REQUEST_ID]+"=PRI."+PstPurchaseRequestItem.fieldNames[PstPurchaseRequestItem.FLD_PURCHASE_REQUEST_ID]+
                        " INNER JOIN "+PstLocation.TBL_P2_LOCATION+" AS LC "+
                        ...
                        " ON PU."+PstUnit.fieldNames[PstUnit.FLD_UNIT_ID]+"=PRI."+PstPurchaseRequestItem.fieldNames[PstPurchaseRequestItem.FLD_UNIT_REQUEST_ID]+
          ...
          dbrs = DBHandler.execQueryResult(sql);
           ...
           while (rs.next()) {
                ...
                material.setSku(rs.getString("PM.SKU"));
                material.setName(rs.getString("PM.NAME"));
                material.setStockUnitRequestId(rs.getLong("PRI.UNIT_REQUEST_ID"));
