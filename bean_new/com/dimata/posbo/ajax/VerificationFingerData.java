...
extends HttpServlet{
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String urlDestination=""+String.valueOf(employeeOID)+";"+""+fingerPatern.getFingerPatern()+""+";SecurityKey;"+timeLimitVer+";"+base+"/cashier/process_verification.jsp;"+base+"/cashier/getac.jsp;extraParams";
